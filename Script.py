...
✯ 𝙱𝚄𝙸𝙻𝙳 𝚅𝙴𝚁𝚂𝙸𝙾𝙽: 𝚟3.0.0"""
    ...
    SOURCE_TXT = """<b>NOTE:</b>
- 𝚂𝙾𝚄𝚁𝙲𝙴 𝙲𝙾𝙳𝙴 𝙲𝙻𝙸𝙲𝙺 𝙷𝙴𝚁 👉 :<a href=https://github.com/MrMKN>𝐏𝐑𝐎𝐅𝐄𝐒𝐒𝐎𝐑</a>

<b>DEVS:</b>
- 𝙳𝚎𝚟 1<a href=https://t.me/HELL_GaM>𝚃𝙶</a>
"""
...
- can Manage bot using /settings command

<b>NOTE:</b>
1. Only admins of your own group can add a connection.
